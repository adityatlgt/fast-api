...
# database
from models import (User, Business, Product,user_pydantic, user_pydanticIn, user_pydanticOut,business_pydantic, business_pydanticIn,product_pydantic, product_pydanticIn)
# authentication
from authentication import (get_hashed_password,token_verification,is_not_email, token_generator)
...
app.mount("/static", StaticFiles(directory="static"), name="static") #to server static files

"""
This API provides bearer token
METHOD: POST
"""
...
async def get_current_user(token: str = Depends(oauth_scheme)):
    return await token_verification(token)


"""
This API provides users data
METHOD: POST
"""
@app.post("/user_data", tags=["User"])
...
"""
This API Provides the Users Data
Method: GET
"""
...
"""
This is a post save signal.Used to save data in business modal
"""
@post_save(User)
...
"""
This API updates the Data related to business table
METHOD: PUT
"""
...
METHOD: POST
"""
@app.post("/user_register/", tags=["User"], status_code=status.HTTP_201_CREATED, response_model=user_pydanticOut)
...
"""
This API is used to upload image files
METHOD: POST
"""
...
"""
This API is used to upload product information
METHOD: POST
"""
...
"""
This API delete's the product using id
METHOD: DELETE
"""
...
"""
Thid API updates the product using ID
METHOD: PUT
"""
...
"""
This API provides all products
METHOD: GET
"""
...
"""
This API provides the product information by id of the product.
METHOD: GET
"""
